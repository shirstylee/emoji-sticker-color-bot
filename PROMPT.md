# Архив первоначального технического задания

Этот документ сохранён как история требований. Он не является текущей инструкцией
по запуску или разработке, и часть пунктов уже изменена. Актуальное поведение описано
в README.md, PRIVACY.md и тестах; правила внесения изменений — в CONTRIBUTING.md.
