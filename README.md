...
- 🎚️ **Три уровня интенсивности** — бережная сохраняет больше исходного оттенка, обычная сохраняет светотень, а насыщенная даёт плотную яркую заливку с затемнёнными бликами.
